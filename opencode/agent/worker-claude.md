---
description: "Claude-pool fallback for worker (well-specified mechanical implementation). Use ONLY when the OpenAI Pro quota is exhausted or OpenAI is down."
mode: subagent
