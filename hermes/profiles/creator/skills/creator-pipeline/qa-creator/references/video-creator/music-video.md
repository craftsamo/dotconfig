# Quality assurance — video-creator: music-video
...
video. After generation use the [clip review path](clip.md), comparing the hands'
...
For reference-led spatial actions (START / CROSS / AFTER evidence), see the
shared video review in [clip.md](clip.md#reference-led-spatial-actions-shared-video-review).
