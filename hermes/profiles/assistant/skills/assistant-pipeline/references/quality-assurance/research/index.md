...
Applies to researcher deliverables (session turns and
`claim-verification` cards); searcher retrieval gates through
`../search/index.md`. The common floor in `../index.md` always
applies.
...
- For `claim-verification` results: every claim in the list has a
  verdict and sources; no claim silently dropped.
